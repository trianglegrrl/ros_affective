...
# sensory_input.py
#
# ros_affective sensory input node 
...
#	
#	This node is customized per robot, and subscribes to whatever interpretational senses it has. 
# 	The important bit here is that we're doing more than, say, subscribing to an image topic:
#	we're detecting interesting things in the world, and telling the rest of ros_affective
#	about it. Some examples might be having the robot detect a red ball and get really
# 	excited about it; having the robot hear its name and trigger some attentional action;
#	or Leonardo hating Cookie Monster.
...
if __name__ == "__main__":
  try:
    ...
    sense = rospy.Publisher ("/affective/sense", String)
