...
(cl:defmethod cl:initialize-instance :after ((m <Velocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_affective-msg:<Velocity> is deprecated: use ros_affective-msg:Velocity instead.")))
